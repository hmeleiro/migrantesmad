...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-449602.698317, 4917397.875000, -395133.775240, 4950165.875000], maxZoom: 28, minZoom: 4
    })
});
...
map.getView().fit([-449602.698317, 4917397.875000, -395133.775240, 4950165.875000], map.getSize());
